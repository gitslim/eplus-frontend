<script>
    ...
    import {faChartBar, faHistory, faRoad, faUsers} from '@fortawesome/free-solid-svg-icons'
</script>
                ...
                <div class="box">
                    <div class="media">
                        ...
                        <div class="media-content has-text-right">
                            <h3 class="title is-1 has-text-info">18</h3>
                        </div>
                    </div>
            ...
            <div class="column is-6-tablet is-3-desktop">
                <div class="box">
                    <div class="media">
                        ...
                        <div class="media-content has-text-right">
                            <h3 class="title is-1 has-text-danger">183</h3>
                        </div>
                    </div>
            ...
            <div class="column is-6-tablet is-3-desktop">
                <div class="box">
                    <div class="media">
                        ...
                        <div class="media-content has-text-right">
                            <h3 class="title is-1 has-text-success">390</h3>
                        </div>
                    </div>
            ...
            <div class="column is-6-tablet is-3-desktop">
                <div class="box">
                    <div class="media">
                        ...
                        <div class="media-content has-text-right">
                            <h3 class="title is-1 has-text-info">570</h3>
                        </div>
                    </div>
